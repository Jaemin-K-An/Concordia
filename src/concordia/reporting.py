...
<h2>12. Reproducibility</h2><p>Run <code>make lint test benchmark simulation-test research rl-gate rl-evaluate report</code>. Heavy microscopic full matrices are not silently substituted by analytical output. The committed analytical and microscopic study manifests identify the exact source commits and hashes.</p>
