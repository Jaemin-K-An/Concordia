...
| Real OSM SUMO conversion | **PASS** | [`sumo_conversion.json`](artifacts/studies/real_topology/sumo_conversion.json): netconvert 1.27.1, output hash, 835 edge elements. |
